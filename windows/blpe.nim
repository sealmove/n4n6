...
struct(*optionalHeaderStd, endian = l):
...
struct(*optionalHeaderWindowsSpecificPe32, endian = l):
  u32: *imageBase
...
struct(*optionalHeaderWindowsSpecificPe32Plus, endian = l):
  u64: *imageBase
  u32: *sectionAlignment
  u32: *fileAlignment
  u16: *majorOSVersion
...
union(*optionalHeaderWindowsSpecific, *PeFormat):
  (pfPe32): *optionalHeaderWindowsSpecificPe32: *pe32
  (pfPe32Plus): *optionalHeaderWindowsSpecificPe32Plus: *pe32Plus
  _: nil

struct(*dataDirectory, endian = l):
  u32: *virtualAddress
  u32: *size

struct(*dataDirectories, endian = l):
...
struct(*optionalHeader, endian = l):
